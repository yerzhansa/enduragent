...
describe("built i18n dependency boundaries", () => {
  ...
  it("accepts cyclic safe imports and JSON catalog modules", () => {
    ...
    write(
      "dist/shared.js",
      'import "./index.js"; export const load = () => import("./en.json", { with: { type: "json" } });',
    );
  ...
  it("requires all built entries and permits React only from the React entry", () => {
    ...
    write(
      "packages/i18n/node_modules/react/package.json",
      '{"name":"react","exports":"./index.js"}',
    );
    write("packages/i18n/node_modules/react/index.js", "export const createContext = () => null;");
    write(
      "packages/i18n/node_modules/i18next/package.json",
      '{"name":"i18next","exports":"./index.js"}',
    );
    write(
      "packages/i18n/node_modules/i18next/index.js",
      "export const createInstance = () => null;",
    );
