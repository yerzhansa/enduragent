...
@Suite struct KeychainStoreTests {
	...
	@Test func openRouterKeyAndIntervalsCredentialRoundTrip() throws {
		...
		try store.storeOpenRouterKey("sk-or-v1-test")
		#expect(try store.openRouterKey() == "sk-or-v1-test")
		try store.storeOpenRouterKey("sk-or-v1-rotated")
		#expect(try store.openRouterKey() == "sk-or-v1-rotated")
