...
const BASELINE: readonly Usage[] = [
  ...
  { file: "ui/settings/TrainingRestrictionCard.tsx", className: "size-[18px]" },
  { file: "ui/settings/TrainingRestrictionCard.tsx", className: "text-[10px]" },
  { file: "ui/settings/TrainingRestrictionCard.tsx", className: "text-[12.5px]" },
